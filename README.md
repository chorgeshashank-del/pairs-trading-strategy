...
The reconstructed equity-cleaning script was verified against the saved dataset: all 68,309 rows and 17 columns matched within numerical tolerance. It uses the repaired yearly extracts and four cached Muhurat-session reports. Formation diagnostics and final stock eligibility were also reproduced successfully. The reconstructed corporate-action ledger matched all 446 rows and 41 columns of the saved ledger exactly, including event IDs and review flags. This verifies reproduction of the saved classifications, not independent validation of every treatment decision. Reconstruction of the original exchange downloads and yearly repairs remains unverified.
